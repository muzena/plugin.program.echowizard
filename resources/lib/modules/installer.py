...
def INSTALL_KEYMAP(name,url,description):
	...
	xbmc.executebuiltin("Container.Refresh")
	dialog.ok(AddonTitle, "[COLOR white]Custom Keymap settings installed![/COLOR]","[COLOR white]Thank you for using ECHO Wizard![/COLOR]")

def INSTALLAPK(name,url,description):

	if "NULL" in url:
		dialog = xbmcgui.Dialog()
		dialog.ok(AddonTitle, "[B][COLOR smokewhite]Not a valid selection, please try again.[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
		sys.exit(1)
...
def INSTALLLIB(name,url,description):
	...
	if "Android" in name:
		if not xbmc.getCondVisibility('system.platform.android'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - Android", "[B][COLOR smokewhite]Sorry, this file is only for Android devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.so"
	...
	if "Windows" in name:
		if not xbmc.getCondVisibility('system.platform.windows'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - Windows", "[B][COLOR smokewhite]Sorry, this file is only for Windows devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.dll"
	...
	if "Linux" in name:
		if not xbmc.getCondVisibility('system.platform.linux'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - Linux", "[B][COLOR smokewhite]Sorry, this file is only for Linux devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.so.1"
			path = xbmc.translatePath(os.path.join('special://home',''))
	...
	if "osx" in name:
		if not xbmc.getCondVisibility('system.platform.osx'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - MacOSX", "[B][COLOR smokewhite]Sorry, this file is only for MacOSX devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
	...
	if "ATV" in name:
		if not xbmc.getCondVisibility('system.platform.atv2'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - ATV", "[B][COLOR smokewhite]Sorry, this file is only for ATV devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.1.dylib"
			path = xbmc.translatePath(os.path.join('special://home',''))
	...
	if "iOS" in name:
		if not xbmc.getCondVisibility('system.platform.ios'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - iOS", "[B][COLOR smokewhite]Sorry, this file is only for iOS devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.1.dylib"
			path = xbmc.translatePath(os.path.join('special://home',''))
	...
	if "RPi" in name:
		if not xbmc.getCondVisibility('system.platform.rpi'):
			dialog = xbmcgui.Dialog()
			dialog.ok(AddonTitle + " - RPi", "[B][COLOR smokewhite]Sorry, this file is only for RPi devices[/COLOR][/B]",'[COLOR smokewhite]Thank you for using ECHO Wizard[/COLOR]')
			sys.exit(1)
		else:	
			name = "librtmp.1.so"
			path = xbmc.translatePath(os.path.join('special://home',''))
